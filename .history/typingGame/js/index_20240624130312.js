document.addEventListener('DOMContentLoaded', function () {
    ...
    const calculateTypingSpeed = (time_taken) => {
        ...
        score.innerHTML = `Your typing speed is ${typingSpeed} words per minute & you wrote ${correctWords} correct words out of ${sentenceToWrite.length} words. Time taken: ${time_taken} sec. Incorrect words: ${incorrectWords.length}. Missing words: ${missingWords}`;
    };
