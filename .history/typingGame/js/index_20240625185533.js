document.addEventListener('DOMContentLoaded', function () {
    ...
    });// Function to apply the selected theme to all text areas
function applyTheme(theme) {
    const textareas = document.querySelectorAll('.styled-textarea');
    textareas.forEach(textarea => {
        textarea.classList.remove('default-theme', 'dark-theme', 'light-theme');
        textarea.classList.add(theme + '-theme');
    });
}
...
// Initially apply the default theme
applyTheme('default');
