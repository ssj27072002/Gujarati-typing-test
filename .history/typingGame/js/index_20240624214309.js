document.addEventListener('DOMContentLoaded', function () {
    ...
    const calculateTypingSpeedAndAccuracy = () => {
        ...
        let totalWords = correctWords + incorrectWords + missingWords;
        let accuracy = (correctWords / totalWords) * 100;
        accuracy = accuracy.toFixed(2);

        score.innerHTML = `Your typing speed is ${typingSpeed} words per minute. Correct words: ${correctWords}, Incorrect words: ${incorrectWords}, Missing words: ${missingWords}, Accuracy: ${accuracy}%. Time taken: ${time_taken} sec.`;
    };
    ...
    typingGround.addEventListener('input', () => {
        ...
        } else if (words[currentWordIndex] !== undefined) {
            incorrectWords++;
        } else {
            missingWords++;
        }
