document.addEventListener('DOMContentLoaded', function () {
    ...
    const endTypingTest = () => {
        ...
        // Highlight incorrect words in the user's input
        ...
        // Update user's input display
        typingGround.value = userWords.join(' '); // Reset to original user input
        typingGround.innerHTML = highlightedWords; // Show highlighted text separately
        typingGround.setAttribute('disabled', 'true');
    };
